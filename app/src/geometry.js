export function create_cube() {
  ...
  return { data: new Float32Array(v), vert_count: 36 };
}

export function create_line_strip(segments) {
  const verts = [];
  ...
  return { data, vert_count: segments * 6 };
}

export function fibonacci_sphere(count) {
