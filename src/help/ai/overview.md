...
Use `--ai-help` on any command for specific guidance:

- `shard init --ai-help` — First-time workspace setup
- `shard daemon --ai-help` — Daemon operations and registry
- `shard connect --ai-help` — IPC session client
- `shard mcp --ai-help` — MCP server and tools
- `shard new --ai-help` — Creating new shards
- `shard dump --ai-help` — Exporting markdown
- `shard --ai-help` — Shard node operations (thoughts, catalogs, gates)